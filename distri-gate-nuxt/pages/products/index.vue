<template>
    <div class="px-10 pt-28">
        <div v-if="productstore.fetching"  class="grid min-[1180px]:grid-cols-4 min-[900px]:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 justify-items-center">
        ...
        <ul v-else class="grid min-[1180px]:grid-cols-4 min-[900px]:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 justify-items-center">
